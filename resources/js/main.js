...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if((rutaActual == "http://localhost/productos")){
    productos()
  }
  if(rutaActual == "http://localhost/carta" || (rutaActual == "http://localhost/cartacliente")){
    carta()
  }
  if(rutaActual == "http://localhost/clientes"){
    clientes()
  }
  if(rutaActual == "http://localhost/pedido"){
    crearPedido();
    vaciarCarrito();
    cargarProductos();
    pintarCarrito();
  }
  if(rutaActual == "http://localhost/formulario"){
    cargarFormulario()
  }
  if(rutaActual == "http://localhost/pedidoscliente"){
    pedidosCliente()
  }
  if(rutaActual == "http://localhost/categorias"){
    categorias()
  }
});
